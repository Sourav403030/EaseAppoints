...
const BookDoctor = () => {
	...
	// 								<li>
	// 									<FaLocationArrow className='icon' /> Ottapalam, Palakkad
	// 								</li>
	// 								<li>
	// 									<FaClock className='icon' /> Available Everyday
	// 								</li>
	// 								<li>
	// 									<FaDollarSign className='icon' /> ₹1000 - ₹1500
	// 								</li>
	// 							</ul>
	...
	// 						<p>We've built a healthcare system that puts your needs first.
	...
	// 					</div>
	// 				</div>
	// 				<div className="col-14 col-md-9 col-lg-9">
	// 					<div className="d-flex justify-content-center align-items-center gap-3 border-10 swiper-div">
	// 						<Swiper class = "swiper"
	// 							spaceBetween={1000}
	// 							slidesPerView={1}
