...
import aboutUs from '../../images/doc/img10.jpeg'
            ...
            <div className="container" style={{ marginBottom: 100, marginTop: 100 }}>
                <div className="row p-5">
                    <div className="col-lg-4">
                        ...
                        <p className='mt-3'>Welcome to our online doctor appointment system, where we strive to redefine healthcare accessibility and convenience. At EaseAppoints, we believe that everyone deserves seamless access to quality healthcare, which is why we've developed a user-friendly platform that connects patients with experienced healthcare providers effortlessly. With a commitment to innovation and patient-centric care, we aim to revolutionize the way healthcare appointments are booked and managed, ensuring that everyone can receive timely and personalized medical attention. Join us in our mission to make healthcare more accessible, convenient, and patient-centered.</p>
                    </div>
