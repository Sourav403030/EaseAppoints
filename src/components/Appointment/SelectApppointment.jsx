            ...
            <dir className="p-3" style={{ background: '#f8f9fa' }}>
                <div className="row">
                    <div className="col-md-3 col-sm-12 mt-3 info-part border-end">
                        <p className='py-2 border-bottom info-head-date'>Would you like to schedule an Appointment? Pick a Date & Time</p>
                        <div className='icon-box'>
                            ...
                            <div className='d-flex gap-3'>
                                ...
                                <p>Ottapalam, Palakkad<br /><span className="form-text"></span></p>
                            </div>
                            <div className='d-flex gap-3'>
                                <FaLink className='icon' />
                                <p>Google Meet or In-person</p>
                            </div>
                            <div className='d-flex gap-3'>
