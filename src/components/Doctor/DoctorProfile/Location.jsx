                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6">
                                <div className=" clinic-content">
                                    <h4 className="clinic-name"><a href="#">Healthcare Center</a></h4>
                                    <p className="doc-speciality">MBBS, MD</p>
                                    <div className="clinic-details mb-0">
                                        <h5 className="clinic-direction"> <i className="fas fa-map-marker-alt"></i> Ottapalam, Palakkad <br /><a>Get Directions</a></h5>
                                        <ul>
                                            {
