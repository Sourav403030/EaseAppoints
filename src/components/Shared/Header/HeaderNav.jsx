        ...
        <>
            <nav id="navbar" className="navbar order-last order-lg-0">
                <ul>
                    ...
                    <li><NavLink to={'/service'} className={({ isActive }) => isActive ? "nav-link scrollto active" : ""}>Features</NavLink></li>
            ...
            >
                <ul className="mobile-menu-nav">
                    ...
                    <li><NavLink to={'/service'} className={({ isActive }) => isActive ? "nav-link scrollto active" : ""}><FaWrench className="icon" />Features</NavLink></li>
