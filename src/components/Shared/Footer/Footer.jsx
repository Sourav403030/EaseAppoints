...
const Footer = () => {
	...
	// 								<p className='form-text' style={{maxWidth:200}}>Empowering elderly care by bringing medical specialists to your doorstep with EaseAppoints </p>
	// 							</div> */}
	// 						</div>
	// 					</div>
	...
	// 									<p> Ottapalam<br /> Palakkad, Kerala </p>
	// 								</div>
	// 								<p>
